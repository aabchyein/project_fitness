          ...
          <% Paginations paginations=(Paginations)result.get("paginations"); %>
            ...
            <div class="text-center mt-4">
              <ul class="pagination justify-content-center">
                <li class="page-item">
                  <a class="page-link"
                    href="/fitness/NoticeAll?currentPage=<%= paginations.getPreviousPage() %>">Previous</a>
                ...
                %>
                  <li class="page-item">
                    <a class="page-link" href="/fitness/NoticeAll?currentPage=<%= i %>"><%= i %></a>
                  </li>
                  <% } %>
                    ...
                    <li class="page-item">
                      <a class="page-link" href="/fitness/NoticeAll?currentPage=<%= paginations.getNextPage() %>">Next</a>
                        <span aria-hidden="true">&gt;</span>
                      </a>
                    </li>
              </ul>
