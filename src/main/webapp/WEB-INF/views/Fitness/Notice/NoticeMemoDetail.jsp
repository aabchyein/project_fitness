...
%>
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="TITLE" value='<%= record.get("TITLE") %>' id="title" readonly>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <textarea class="form-control" name="CONTENTS"  id="content" rows="5" readonly><%= record.get("CONTENTS") %></textarea>
      </div>
