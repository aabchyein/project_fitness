  ...
  <div class="container mt-5">
    ...
    <form  method="post">
      ...
      <div class="form-group mt-4">
        ...
        <textarea class="form-control" name="CONTENTS" id="content" rows="5" placeholder="내용을 입력하세요"></textarea>
      </div>
     
        <div class="d-flex justify-content-end m-5">
            <button type="submit" class="btn btn-primary" formaction="/insertAndSelect" formmethod="post">등록</button>
