...
<nav class="navbar navbar-expand-lg bg-black">
  <div class="container">
    ...
    <form class="d-flex col-lg-5">
      <input class="form-control search-input me-2" type="search" placeholder="원하시는 업체명이나 지역을 검색해 보세요" aria-label="Search">
      <button class="btn " style="background-color: #8B0000; color: white;" formaction="./Search.html">검색</button>
    </form>

    <div class="col-lg-4 text-lg-ende">
