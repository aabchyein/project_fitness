...
INSERT INTO MEMBER_INFORMATION (ID, NAME, PASSWORD, BIRTHDATE, PHONE_NUMBER, EMAIL_ADDRESS, ADDRESS, GENDER_ID, JOIN_DATE)
VALUES
  ('user789', '태식', 'SecurePass987', '1993-04-17', '010-9999-3333', 'taesik@example.com', '서울시', 'GEN01', '2023-07-05'),
  ('sarahlee', '사라', 'Paw0rd', '1995-12-25', '010-7777-8888', 'sarahlee@example.com', '서울시', 'GEN02', '2023-07-20'),
  ('admin123', '김홍도', 'Pssw0rd123', '1990-01-01', '010-1234-5678', 'user123@gmail.com', '서울시', 'GEN01', '2023-08-13'),
  ('johndoe', '이종도', 'Password9876', '1985-03-15', '010-9876-5432', 'johndoe@example.com', '서울시', 'GEN01', '2023-08-07'),
  ('annasm', '안나', 'SecurePass456', '1992-07-22', '010-5555-1234', 'annasm@example.com', '서울시', 'GEN02', '2023-09-10'),
  ('user456', '알렉스', '1234abcd', '1988-09-10', '010-1111-2222', 'alex@example.com', '서울시', 'GEN01', '2023-10-01'),
  ('admin987', '이민정', 'M1nJng5678', '1994-08-12', '010-5555-9999', 'minjung@example.com', '서울시', 'GEN02', '2023-05-21'),
  ('davids', '다비드', 'StrongPass123', '1991-06-05', '010-2222-3333', 'david@example.com', '서울시', 'GEN01', '2023-09-05'),
  ('jisulee', '이지수', 'J1sU5678', '1996-02-28', '010-4444-5555', 'jisulee@example.com', '서울시', 'GEN02', '2023-08-15'),
  ('user654', '김성호', 'Password2022', '1987-11-09', '010-6666-7777', 'seongho@example.com', '서울시', 'GEN01', '2023-08-13');
...
INSERT INTO LOCAL_HUMAN (LOCAL_NAME, HUMAN_COUNT) VALUES
('서울특별시 서울특별시 종로구 (1111000000)', 139945),
('서울특별시 서울특별시 중구 (1114000000)', 121405),
('서울특별시 서울특별시 용산구 (1117000000)', 216152),
('서울특별시 서울특별시 성동구 (1120000000)', 278366),
('서울특별시 서울특별시 광진구 (1121500000)', 336604),
('서울특별시 서울특별시 동대문구 (1123000000)', 341238),
('서울특별시 서울특별시 중랑구 (1126000000)', 382797),
('서울특별시 성북구 (1129000000)', 427671),
('서울특별시 강북구 (1130500000)', 290155),
('서울특별시 도봉구 (1132000000)', 307740),
('서울특별시 노원구 (1135000000)', 499989),
('서울특별시 은평구 (1138000000)', 467098),
('서울특별시 서대문구 (1141000000)', 307441),
('서울특별시 마포구 (1144000000)', 364257),
('서울특별시 양천구 (1147000000)', 437401),
('서울특별시 강서구 (1150000000)', 564339),
('서울특별시 구로구 (1153000000)', 393929),
('서울특별시 금천구 (1154500000)', 228611),
('서울특별시 영등포구 (1156000000)', 375586),
('서울특별시 동작구 (1159000000)', 380154),
('서울특별시 관악구 (1162000000)', 485172),
('서울특별시 서초구 (1165000000)', 406404),
('서울특별시 강남구 (1168000000)', 540957),
('서울특별시 송파구 (1171000000)', 655744),
('서울특별시 강동구 (1174000000)', 458385);
