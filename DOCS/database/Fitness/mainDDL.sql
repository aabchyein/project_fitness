...
(
  ...
  COMPANY_NAME VARCHAR(500)  NOT NULL COMMENT '업체명',
...
(
  LOCAL         VARCHAR(50) NOT NULL COMMENT '지역',
  POEPLE_COUNT  INTEGER NOT NULL COMMENT '인구수',
  COMPANY_COUNT INTEGER NOT NULL COMMENT '업체수'
) COMMENT '지역별 인구&업체수';
...
(
  ...
  GENDER_ID     VARCHAR(50) NOT NULL COMMENT '성별ID',
  JOIN_DATE     VARCHAR(50) NOT NULL COMMENT '가입날짜',
  PRIMARY KEY (ID)
) COMMENT '회원정보';
...
=======
  NOTICE_ID       VARCHAR(50) NOT NULL COMMENT '공지사항ID',
  NOTICE_TITLE    VARCHAR(500) NOT NULL COMMENT '공지제목',
  NOTICE_CONTENTS VARCHAR(1000) NOT NULL COMMENT '공지내용',
  NOTICE_DATE     VARCHAR(50) NOT NULL COMMENT '공지날짜',
  NOTICE_VIEWS    INTEGER     NOT NULL COMMENT '공지조회수',
  ID              VARCHAR(50) NOT NULL COMMENT '회원ID',
>>>>>>> be1d1a0ae8e36e63faface69db5cf57383e90137
...
(
  ...
  NOTES            VARCHAR(1000) NOT NULL COMMENT '참고사항',
  ID               VARCHAR(50) NOT NULL COMMENT '회원ID',
  COMPANY_ID       VARCHAR(50) NOT NULL COMMENT '업체ID',
...
<<<<<<< HEAD
  ...
  ID         VARCHAR(50)   NOT NULL COMMENT '회원ID',
  COMPANY_ID VARCHAR(50)   NOT NULL COMMENT '업체ID',
  SENTIMENT  VARCHAR(50)   NOT NULL COMMENT '감성예측',
=======
  REVIEW_ID  VARCHAR(50) NOT NULL COMMENT '후기ID',
  REVIEW     VARCHAR(1000) NOT NULL COMMENT '후기',
  GRADE      INTEGER     NOT NULL COMMENT '평점',
