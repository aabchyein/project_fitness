...
CREATE TABLE BOARD
(
           INTEGER     NOT NULL COMMENT '번호',
  ID       VARCHAR(50) NOT NULL COMMENT '아이디',
  TITLE    VARCHAR(50) NOT NULL COMMENT '제목',
  CONTENTS VARCHAR(50) NOT NULL COMMENT '내용',
           VARCHAR(50) NOT NULL COMMENT '날짜',
...
(
  COMPANY_ID   VARCHAR(200) NOT NULL COMMENT '업체ID',
...
(
  ...
  NOTICE_VIEWS    VARCHAR(50)  NOT NULL COMMENT '공지조회수',
  UNIQUE_ID       VARCHAR(200) NOT NULL COMMENT '대표값',
  ID              VARCHAR(50)  NOT NULL COMMENT '회원ID',
...
ALTER TABLE BOARD
  ADD CONSTRAINT FK_BOARD_ANSWER_TO_BOARD
    FOREIGN KEY (BOARD_ANSWER_ID)
    REFERENCES BOARD_ANSWER (BOARD_ANSWER_ID);
